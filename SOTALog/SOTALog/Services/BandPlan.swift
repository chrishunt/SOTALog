...
enum BandPlan {
    ...
    static let bands: [BandEntry] = [
        ...
        BandEntry(name: "60m",  lower: 5.330, upper: 5.410,   ssbBoundary: nil),
        BandEntry(name: "40m",  lower: 7.000, upper: 7.300,   ssbBoundary: 7.125),
        BandEntry(name: "30m",  lower: 10.100, upper: 10.150, ssbBoundary: nil),
    ...
    /// Returns "CW" or "SSB" based on frequency position within the band, or nil if out of band.
